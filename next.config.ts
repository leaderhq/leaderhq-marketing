...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    const marketingHosts = [
      { type: "host" as const, value: "leaderhq.io" },
      { type: "host" as const, value: "www.leaderhq.io" },
    ];
    return [
      ...marketingHosts.flatMap((has) => [
        {
          ...
          has: [has],
          destination: "https://app.leaderhq.io/:path",
          permanent: true,
        },
        {
          source: "/dashboard/:path*",
          has: [has],
          destination: "https://app.leaderhq.io/dashboard/:path*",
          permanent: true,
        },
      ]),
    ];
