...
export const metadata: Metadata = {
  title: 'For Conferences & Events — LeaderHQ',
  description:
    'Work the room and actually follow up with everyone. LeaderHQ surfaces every contact, conversation, and coaching signal from conference season — so nothing slips.',
